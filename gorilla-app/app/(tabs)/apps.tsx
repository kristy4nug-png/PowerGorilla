...
export default function AppsScreen() {
  ...
  }, [search, category, installedOnly, openSourceOnly, offset]);
  ...
  }, [search, category, installedOnly, openSourceOnly]);
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); loadApps(true); }} tintColor={Colors.accent} />}
